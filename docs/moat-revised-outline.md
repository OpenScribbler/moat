...
All 16 issues tracked against v0.4.0 are resolved or deferred. The full decision log — including rationale and claims for contentious decisions — is in [`docs/issues-archive.md`](issues-archive.md).
