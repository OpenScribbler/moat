...
description: How to set up the MOAT Publisher Action to sign and attest your AI agent content.
---
...
You don't need to notify registries — they crawl on schedule. If the registry supports the optional webhook, you can configure it for faster propagation (see `registry-webhook` in the [Publisher Action spec](/spec/publisher-action)).
