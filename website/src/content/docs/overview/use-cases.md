---
title: Use cases
description: Who does what in MOAT — concrete scenarios for publishers, registry operators, and end users.
---
...
**What MOAT can do for you:** You can run [`moat-verify`](/guides/consumers) yourself to check whether the content you copied matches what a registry has attested. Point it at the directory and a registry manifest URL:
...
**What you do:** After installation, run [`moat-verify`](/guides/consumers) against the installed content directory:
...
Your content is public — anyone can read it, and MOAT registries index public content like search engines index public websites. If you want to signal that you don't endorse a particular registry's use of your content, you can post a publisher revocation via the [Publisher Action](/spec/publisher-action). Publisher revocations are warnings to end users, not hard blocks — only registry revocations are hard blocks.
