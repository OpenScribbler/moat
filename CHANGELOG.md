...
Trust anchor integration: source binding, delegated publishing, and ecosystem positioning. **Renamed from ACP (Agent Content Provenance) to MOAT (Metadata for Origin, Authorship, and Trust).** Domain separator updated from `ACP-V1:` to `MOAT-V1:`.
